<script lang="ts">
    ...
    async function toggleAnchorMode() {
...
<header class="flex justify-center items-center">
    <nav>
        ...
        <ul>
            ...
            <li
                aria-current={$page.url.pathname === "/timer"
                    ? "page"
                    : undefined}
            >
    ...
    <button class="mr-4" on:click={toggleMiniMode}>MiniMode</button>
    <button on:click={toggleAnchorMode}>Anchor</button>
</header>
